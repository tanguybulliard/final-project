...
function PopupComponent(props) {
  ...
  return props.visible ? /*#__PURE__*/React__default.createElement("div", {
...
function Time(_ref) {
  ...
  var _useState = React.useState(createMinuteList(minuteInterval)),
      minutes = _useState[0];
...
function Years(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    value: years[0] - 2,
    onClick: onYearClick
  }, years[0] - 2), /*#__PURE__*/React__default.createElement("div", {
    className: styles$3.selectableDiv,
    value: years[0] - 1,
    onClick: onYearClick
    ...
    if (i % 3 === 0) {
      return /*#__PURE__*/React__default.createElement("div", {
        ...
        key: Math.random(),
        onClick: onYearClick
      }, years[i]), /*#__PURE__*/React__default.createElement("div", {
        className: styles$3.selectableDiv,
        value: years[i + 1],
        key: Math.random(),
        onClick: onYearClick
      }, years[i + 1]), /*#__PURE__*/React__default.createElement("div", {
        className: styles$3.selectableDiv,
        value: years[i + 2],
        key: Math.random(),
        onClick: onYearClick
    ...
    onClick: onYearClick
  }, years[years.length - 1] + 1), /*#__PURE__*/React__default.createElement("div", {
    className: styles$3.selectableDiv,
    value: years[years.length - 1] + 2,
    onClick: onYearClick
  }, years[years.length - 1] + 2), /*#__PURE__*/React__default.createElement("div", {
    className: styles$3.selectableDiv,
...
function CalendarHeader(_ref) {
  ...
  }, year), /*#__PURE__*/React__default.createElement("div", {
  ...
  }, /*#__PURE__*/React__default.createElement(MdNavigateBefore, {
    onClick: function onClick() {
      if (month === 0) {
        setYear(year - 1);
        setMonth(11);
  ...
  }), /*#__PURE__*/React__default.createElement(MdNavigateNext, {
    onClick: function onClick() {
      if (month === 11) {
        setYear(year + 1);
        setMonth(0);
...
function CalendarContent(_ref) {
  ...
  }))), timeSelector ? /*#__PURE__*/React__default.createElement("div", {
...
function Days(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
  ...
  }, /*#__PURE__*/React__default.createElement(CalendarHeader, {
    ...
    month: month,
    setYear: setYear
  }), /*#__PURE__*/React__default.createElement(CalendarContent, {
...
function Calendar(_ref) {
  ...
  var _useState = React.useState(new Date().getMonth()),
      month = _useState[0],
      setMonth = _useState[1];

  var _useState2 = React.useState(new Date().getFullYear()),
      year = _useState2[0],
  ...
  var _useState9 = React.useState(Array.from({
  ...
  }, selectScreen ? showMonths ? /*#__PURE__*/React__default.createElement(Month, {
    year: year,
    lang: lang,
    setMonth: setMonth,
    setSelectScreen: setSelectScreen
  }) : /*#__PURE__*/React__default.createElement(Years, {
    year: year,
    setYear: setYear,
    setSelectScreen: setSelectScreen
  }) : /*#__PURE__*/React__default.createElement(Days, {
    year: year,
    lang: lang,
    month: month,
    setMonth: setMonth,
...
var Popup = function Popup(_ref2) {
  ...
  return /*#__PURE__*/React__default.createElement(PopupComponent, {
    visible: visible,
