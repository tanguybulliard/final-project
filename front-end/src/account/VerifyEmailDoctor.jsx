...
import { accountService, alertService, doctorService } from "@/_services"
//wont needed it, only if we use fake backend
function VerifyEmailDoctor({ history }) {
	const EmailStatus = {
		Verifying: "Verifying",
		Failed: "Failed",
	}
